    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-card border border-border transition-transform hover:scale-105 active:scale-95 overflow-hidden"
        >
          <img src={grLogo} alt="Gabi" className="h-11 w-11 object-contain" />
        </button>
      )}
