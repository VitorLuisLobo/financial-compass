...
export const allArticles: Article[] = [
  { slug: "power-of-compound-interest", title: "JUROS COMPOSTOS: O SEGREDO DOS RICOS", excerpt: "Como pequenos aportes mensais podem te tornar milionário no longo prazo", category: "FUNDAMENTOS DE INVESTIMENTO", readTime: "5 min", date: "Mar 8, 2026", relatedLibraryTopics: ["risk-vs-return"], instagramUrl: "https://www.instagram.com/reel/EXEMPLO_JUROS_COMPOSTOS/" },
  { slug: "building-your-emergency-fund", title: "RESERVA DE EMERGÊNCIA:\nPOR ONDE COMEÇAR?", excerpt: "Por que essa é a primeira coisa que você precisa saber antes de investir qualquer real.", category: "FINANÇAS PESSOAIS", readTime: "4 min", date: "Mar 5, 2026", relatedLibraryTopics: ["emergency-fund", "saving-strategies"], instagramUrl: "https://www.instagram.com/reel/EXEMPLO_RESERVA/" },
  { slug: "understanding-treasury-bonds", title: "TESOURO DIRETO: SIMPLES, SEGURO E ACESSÍVEL", excerpt: "O guia completo para investir no Tesouro sem medo e complicação", category: "RENDA FIXA", readTime: "6 min", date: "Mar 1, 2026", relatedLibraryTopics: ["treasury-bonds", "what-is-selic"], instagramUrl: "https://www.instagram.com/reel/EXEMPLO_TESOURO/" },
